<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['crm-basicdata:measure:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['crm-basicdata:measure:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['crm-basicdata:measure:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['crm-basicdata:measure:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="measureList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户标识" align="center" prop="userFlag" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.userFlag, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
...
<script>
import { listMeasure, getMeasure, delMeasure, addMeasure, updateMeasure } from "@/api/crm-basicdata/measure";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('crm-basicdata/measure/export', {
        ...this.queryParams
